# Evidence pack: Electroflow
slug: electroflow | domain: eflowtech.com | HQ: San Bruno, California US | employees(LI): 15 | founded: 2023 | stage_band: unknown
sources: vc:harpoon
industry(LI): Chemical Manufacturing | specialties: 
channel notes: sustainable lithium extraction and refining
own-language word count: ~582

## Their own words (website via Exa, livecrawl-preferred)

URL: https://eflowtech.com
Electroflow Technologies Inc. - Unlocking American Lithium

top of page

# Brine to Battery Materials Made in America
...
We envision a world where lithium and other critical materials are no longer a bottleneck in the clean energy transition. In this new world, mineral abundance is achieved through sustainable practices.

### Locally Sourced Lithium

We want to ramp up the local

lithium production environment

### Sustainable Mining

Source lithium with minimal

water and hazardous chemicals

### Simplified Supply Chains

We envision a world where sourced Lithium doesn't travel 1000s of miles

Mission

## OUR MISSION

The key to domestic Lithium: Brines

Brines in North America contain enough lithium to produce over 300 million electric vehicles, yet these resources have been barely touched. With our technology we can extract Lithium from dilute Brines, which unlocks 75% of the Lithium stored in US Brines.
...
##### Traditional Brine to LFP requires 10 steps

Multistep process with high lithium losses and large consumption of water and chemicals
...
- Electrode Fabrication Intern (Summer 2026) ({'city': 'San Bruno', 'country_code': 'US'})
