# Evidence pack: IMAGE INSIGHT, INC.
slug: image-insight-inc | domain: imageinsightinc.com | HQ: East Hartford, Connecticut US | employees(LI): 10 | founded: 2010 | stage_band: revenue_stage
sources: sbir
...
Our team has been awarded more than 100 contracts and task orders from leading U.S. agencies including the Department of Defense and the Department of Homeland Security. GammaPix has been extensively tested by national laboratories in the U.S. and internationally, confirming its reliability and performance in real-world scenarios. Image Insight and GammaPix have twice gone through the Department of Homeland Security SAFETY Act process and received designation as a Qualified Anti-Terrorism Technology (QATT).

Our innovations have been recognized with numerous awards, including:

R&D 100 Award for Top Technology (2012)

Most Innovative Product or Service at the Innovation in Resilience conference, UK (2012)

Tech Company to Watch, CT Innovation Summit (2013)

Current U.S. DoD IDIQ contract vehicles:

JE-RDAP (counter-WMD efforts)

AFLCMC/XA (Air Force software development and modeling and simulation efforts)

Missile Defense Agency - (support to Golden Dome comprehensive missile defense systems)

---

## How Our Technologies Enhance Your Safety

---

#### OUR PRODUCTS

GammaPix ionizing radiation detection (TRL 9)Image Insight developed the GammaPix™ technology to enable widespread detection of ionizing radiation using unmodified digital cameras. With GammaPix software, Commercial-off-the-Shelf (COTS) cameras with standard CMOS sensors can measure dose rates down to background or as high as 1,000 rad/hr in minutes or seconds.

Versions of our software have been specially designed for EOD robots, mobile devices, cargo and check-point inspection, security cameras, and special applications. A wide range of operational data exists that demonstrate the ability of GammaPix to detect and track real world radiological events and activity. Example data analysis products are available upon request.

Applications include:

Border monitoring

Force protection & base defense

Radiological situational awareness during operations in contaminated zones

Rad/nuke intelligence

Routine radiological monitoring

Space radiation and nuclear weapon effects monitoring and assessment

Additional medical and radon applications are under development

Benefits Compared to Current Solutions:

Mission impact: COTS cameras are everywhere, so radiation data can be available anywhere, anytime. Border regions are vast, and often incompletely monitored since most dedicated detectors are too expensive and too fragile to survive in the field. Many rugged CCTV cameras and smartphones are routinely deployed and can contribute to personnel safety and intelligence collection throughout the extended border region.

Cost & Availability: GammaPix uses unmodified COTS devices such as smartphones, tablets, and CCTV security cameras, which reduces hardware cost and alleviates supply chain constraints. COTS equipment can be easily and quickly replaced.

Integration Pathways, Validation, Training:

GammaPix applications feed data to the GammaPix Command Center, or optionally ATAK, JWARN, COT servers, COPERS, Nett Warrior devices, and other Common Operating Picture (COP) products.

Under an Air Force Air Combat Command A29-sponsored project, this capability was incorporated into an NSA ATO (DARKWING/SIGNUS), and we are credentialed to process data in GovCloud.

Image Insight and GammaPix have twice gone through the Department of Homeland Security SAFETY Act process and received designation as a Qualified Anti-Terrorism Technology (QATT) Qualified Anti-Terrorism Technology (QATT).
...
Image Insight Inc. specializes in innovative radiation detection solutions, transforming everyday devices like smartphones and CCTV cameras into powerful tools for public safety. Our patented GammaPix™ technology enables rapid, cost-effective detection of ionizing radiation, supporting national security and emergency response efforts worldwide. Image Insight also develops video analysis software that enables unmodified cameras to detect and track drones (UAS), satellites, rockets and other objects at night.without radar or other EM emissions. Useful for both military and public safety applicat

## SBIR/STTR record (their own abstracts)

### Low-cost Widespread Security Camera Based C-UAS Detection — Air Force 2022 ($750,000)
Adversaries use inexpensive unmanned aerial systems (UAS) to execute lethal attacks and gather intel. To enhance combat effectiveness and lethality, they employ LIDAR Anti-Collision systems (LACS) on UAS. Their use of growing salvo sizes increases the nee
### Dirty Bomb (Radiological Dispersal Device) Detection for EOD Robots — Air Force 2022 ($1,250,000)
