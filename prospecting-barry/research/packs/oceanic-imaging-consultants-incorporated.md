# Evidence pack: Oceanic Imaging Consultants, Incorporated
slug: oceanic-imaging-consultants-incorporated | domain: oicinc.com | HQ: Honolulu, Hawaii US | employees(LI): 7 | founded: 1993 | stage_band: revenue_stage
sources: sbir
industry(LI): Software Development | specialties: multibeam, interferometric, sub-bottom sonars, seafloor mapping, st alone mosaicking module, data acquistion, forward look sonar, hydrographic surveys, sidescan
channel notes: SBIR PhII x1 [2022] Navy latest: Autonomous Navigation-Aiding of Unmanned Underwater Vehicles using Real-Time SLAM hq: Honolulu,HI emp: 6
own-language word count: ~264

## Their own words (website via Exa, livecrawl-preferred)

URL: https://oicinc.com
404 Error
...
Oceanic Imaging Consultants, Inc.(OIC) is the leading manufacturer in easy-to-use seafloor mapping software systems. OIC’s software systems are used by commercial, federal, military, and academic clients worldwide. Our software provides critical solutions to seafloor imaging problems. We are able to accomplish our client’s goals by providing consistent high quality, easy-to-use, turnkey software as well as in-house expertise and excellent customer service. OIC began in 1993 as a spin-off of research performed for the Office of Naval Research at the University of Hawaii. Today, OIC is a full-se

## SBIR/STTR record (their own abstracts)

### Autonomous Navigation-Aiding of Unmanned Underwater Vehicles using Real-Time SLAM — Navy 2022 ($599,860)
...
Suite 200 1144 10th Avenue Honolulu Hawaii 968162442 United States

- Web: http://www.oicinc.com
- Fax: +1 8087914075
