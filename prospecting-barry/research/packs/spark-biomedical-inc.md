# Evidence pack: SPARK BIOMEDICAL INC.
slug: spark-biomedical-inc | domain: sparkbiomedical.com | HQ: Dallas, Texas US | employees(LI): 27 | founded: 2018 | stage_band: revenue_stage
sources: sbir
industry(LI): Medical Equipment Manufacturing | specialties: biotechnology, medical device, neuromodulation
channel notes: SBIR PhII x1 [2023] Army latest: Development and Testing of a Military-Grade Wearable Transcutaneous Auricular Neurostimulation Device to Restore Perform hq: Dallas,TX emp: 15
own-language word count: ~1814

## Their own words (website via Exa, livecrawl-preferred)

URL: https://sparkbiomedical.com
Spark Biomedical Transcutaneous Auricular Neurostimulation for Opioid Withdrawal Relief
...
Empower the facility With options to differentiate and grow while avoiding risks and potential losses

Empower staff With the tools necessary to address complexity in the moment and keep patients moving forward

Empower patientsTo remain actively engaged in treatment so they move beyond the concerns of their complex needs
...
Discover how cutting-edge neurostimulation technology is transforming neurological health today—and explore its groundbreaking potential in pediatrics, hemostasis, and women’s health. Stay ahead of the future of treatment.
...
The Neuroscience Neur

URL: https://sparkbiomedical.com/about
About Spark Biomedical | Pioneering Wearable Neurostimulation Solutions

### Our Vision

We envision a world where personalized and accessible healthcare transforms lives through the power of bioelectronic medicine. As a leader in wearable neurostimulation, Spark Biomedical connects groundbreaking science with real-world applications across mental health, women’s health, hemostasis, and pediatrics. In collaboration with patients, providers, and researchers, we are setting new standards for care and well-being.

## Our Mission

At Spark Biomedical, our mission is to transform healthcare by advancing bioelectronic medicine through pioneering wearable neurostimulation solutions. We aim to address critical needs in mental health, women’s health, hemostasis, and pediatrics, providing safe, effective alternatives to traditional therapies. By empowering healthcare providers and researchers with innovative technology, we are committed to elevating patient outcomes and building a healthier, more resilient future.
...
We believe every team member, partner, and customer has a Spark of genius to share. It’s our job to combine our individual sparks and kindle them to ignite bolder and brighter ideas that improve more lives. So, we suspend judgment, listen carefully, collaborate, and transcend politics to ensure no spark is left behind.

## Building a Better Way Forward

Discover how our clinical trials are shaping the future of treatment. Visit our Neuroscience Page to learn more.

See Clinical Tri

URL: https://sparkbiomedical.com/news-and-events
News and Events | Spark Biomedical
...
#### Spark Biomedical Launches Pivotal Phase II LUNA Trial for Heavy Menstrual Bleeding

This is some text inside of a div block.

The LUNA Trial Marks a Major Clinical Milestone in Bioelectronic Medicine for Women’s Health
...
#### Spark Biomedical Announces Investment by Northwell Holdings to Advance Their OhmBody™ Transcutaneous Auricular Neurostimulation (tAN) for Menstruation
...
#### UT Southwestern and UTMB Awarded $500,000 TRC4 Grant to Study Non-Invasive Neurostimulation for Chronic Subdural Hematomas
...
The Neuroscience Neurological Health Hemostasis Pediatrics Researchers

Veterans Administration Spark a Conversation About News & Events

Spark Biomedical, Inc.18208 Preston RoadSuite D9 531Dallas, Texas 75252(844) 654-SPR

## LinkedIn about

Revolutionizing healthcare as pioneers in non-invasive neurostimulation solutions. At Spark Biomedical, we are defined by our boldness, agility, and collaborative spirit. Committed to unlocking the potential of neurostimulation technology for diverse health challenges. We aim to equip providers and researchers with innovative, evidence-based solutions that redefine approaches to treatment - inspired by our commitment to offer more to patients. Our journey began in Dallas in 2018, where we broke barriers with the Sparrow Therapy System, the first generation of our safe, comfortable, drug-free, 

## SBIR/STTR record (their own abstracts)

### Development and Testing of a Military-Grade Wearable Transcutaneous Auricular Neurostimulation Device to Restore Performance after Acute Stress Reaction — Army 2023 ($1,149,775)
...
Spark Biomedical, Inc.18208 Preston RoadSuite D9 531Dallas, Texas 75252(844) 654-SPRK (7775)

© Copyright 2025 Spark Biomedical, Inc. All rights reserved.

Privacy Policy| Terms & Conditions| Warranty| Financial Conflict
- Spark Biomedical Awarded $1.15M Department of Defense Phase (2023-08-29) https://www.globenewswire.com/news-release/2023/08/29/2733828/0/en/Spark-Biomedical-Awarded-1-15M-Department-of-Defense-Phase-II-STTR-Grant-in-Partnership-with-Battelle-Memorial-Institute.html
  Spark Biomedical Awarded $1.15M Department of Defense Phase --
...
August 29, 2023 14:52 ET | Source: Spark Biomedical Spark Biomedical
