# Evidence pack: SYSTEMS DEFINITION INC
slug: systems-definition-inc | domain: systemsdefinition.com | HQ: Alexandria, Virginia US | employees(LI): 24 | founded: 2002 | stage_band: revenue_stage
sources: sbir
industry(LI): Software Development | specialties: 
channel notes: SBIR PhII x1 [2022] Air Force latest: DoD Personnel Accountability For Responders (DPAR) hq: Alexandria,VA emp: 25
own-language word count: ~1169

## Their own words (website via Exa, livecrawl-preferred)

URL: https://systemsdefinition.com
Systems Definition, Inc.

## Innovative First Responder Solutions & Industry Leading Technical Services
...
### “What we have learned from our prior and on-going personnel accountability efforts is the critical importance of simplicity and ease of use. DoD First Responders, just like civilian First Responders, need tools and capabilities like these to enhance safety and increase operational awareness.”

— Brendan Adams, SDI Software Developer

­

­

URL: https://www.systemsdefinition.com/about-us
About Us — Systems Definition, Inc.
...
URL: https://www.systemsdefinition.com/cart
Systems Definition, Inc.
...
[
![Systems Definition, Inc.](//images.squarespace-cdn.com/content/v1/602c25f4429a247c66ca0f79/1617568919359-XDJQMR6QYS8PCVYIFBCJ/huge.png?format=1500w)
](/)
[
](https://www.linkedin.com/company/systems-definition-inc)
[
](https://www.facebook.com/SystemsDefinitionInc/)
[
](https://twitter.com/systemsdef)
Open Menu
Close Menu
[
![Systems Definition, Inc.](//images.squarespace-cdn.com/content/v1/602c25f4429a247c66ca0f79/1617568919359-XDJQMR6QYS8PCVYIFBCJ/huge.png?format=1500w)
...
URL: https://www.systemsdefinition.com/staff
Our Team — Systems Definition, Inc.

## Meet the Team

#### Brendan AdamsSoftware Engineer

Brendan performs software engineering, coding, and testing in support of SDI’s Penn State University (PSU) Applied Research Laboratory (ARL) Customer. He was the lead application developer for SDI’s roll call application software. He also developed the innovative firefighter RFID Tour Roster and Ride List software applications.

Contact

#### Caleb AdamsSoftware Engineer

Caleb supports software design and development of the Virtual Mission Operations Center (VMOC) satellite mission management framework for the Naval Research Laboratory (NRL). He leads efforts to modernize the web application architecture to improve the longevity and maintainability of the program. He interfaces with stakeholders and mission developers that utilize the VMOC framework to meet government requirements for numerous ongoing satellite missions that NRL supports.

Contact

#### Patrick AframDevOps Engineer

Patrick supports numerous fireground accountability solution deployments. He provides development and test support to SDI efforts related to fireground accountability applications developed for FDNY and other fire departments across the United States.

Contact

#### Frank BriesePresident & Founder

As President, Frank leads SDI technical and corporate activities. He has over 25 years experience with space, aerospace, software, and communications programs, including space development projects, prototype and production avionics, maritime domain systems, and developmental terrestrial systems. His significant program management and system planning experience spanning a variety of technologies enables SDI to address broad-based challenges.

Contact

#### Cory ClarkPrincipal Engineer

Cory serves as an engineer and supports SDI’s fireground accountability projects. He provides assistance with deployments, development, testing, and quality control efforts. He has extensive radio experience and has implemented radio features across a variety of platforms. He has developed novel metal detection/anti-theft algorithms and has experience integrating FPGA to GPP\DSP for military\DoD tactical radio products.

Contact

#### DeVissi CrockettFinancial Reporting Analyst

Mr. Crockett supports U.S. Naval Research Laboratory (NRL) financial reporting and data collection for multiple NRL programs. He coordinates with program technical and management personnel to develop cost budgets and spend plans and to m
...
- Virginia Colleges
- Virginia College Newspapers

Go To Another State

## Breeze | James Mad
- Systems Definition, Inc. () https://www.systemsdefinition.com/
  Systems Definition, Inc.
...
SDI provides focused and efficient technical services and application software 
