# Evidence pack: VertiPrime Government Services, LLC
slug: vertiprime-government-services-llc | domain: vertiprime.com | HQ: Duncan, Oklahoma US | employees(LI): 3 | founded: 2016 | stage_band: revenue_stage
sources: sbir
industry(LI): Defense and Space Manufacturing | specialties: 
channel notes: SBIR PhII x1 [2022] Air Force latest: TACFI - Integrated Procurement AI Platform Incorporating IoT of CNC Machines Using Encrypted P2P Transfer Protocols for  hq: Duncan,OK emp: 5
own-language word count: ~391
...
VertiPrime is an Oklahoma company that manufactures precision structural parts for the aerospace industry. Founded by Michael Morford and James Morford, both veterans of the Iraqi War, VertiPrime is formally-recognized Service Disabled Veteran Owned Small Business (SDVOSB) by the Department of Veterans Affairs (VA). With two CNC Machining facilities in Duncan, OK, our primary focus is to be a prime contractor to the Department of Defense for the U.S. Military\'s aging aviation fleet. Our Mission is to support the war fight abroad from home by becoming the most respected SDVOSB in the U.S. in t

## SBIR/STTR record (their own abstracts)

### TACFI - Integrated Procurement AI Platform Incorporating IoT of CNC Machines Using Encrypted P2P Transfer Protocols for USAF Sustainment Efforts — Air Force 2022 ($1,694,432)
...
## Machine Learning Methods to Support Workforce Fragility Mitigation

### Awardee

#### VertiPrime Government Services, LLC

https://www.sbir.gov/portfolio/1615189 7576 N Highway 81 Ste 25Duncan, OK, 73533-3400USA
