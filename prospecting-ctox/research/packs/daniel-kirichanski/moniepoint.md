# Evidence pack — moniepoint (for CTO daniel-kirichanski)
ATS: greenhouse | liveness: live | feed slug: moniepoint
...
### Head of Engineering, POS Application Platform  [score 0.5451, live=True]
apply: https://job-boards.eu.greenhouse.io/moniepoint/jobs/4900313101
posted: 2026-06-16T12:34:27-04:00 | company_does: africa's all-in-one financial platform powering payments, banking, credit, cross-border, and business tools | industry: fintech | stage: growth_startup
...
**About the role**
 
More than 6 million businesses run their financial lives through Moniepoint — and the primary way they interact with us every single day is through a POS device. For most of our merchants, that device is their business. It is how they accept payments, how they access credit, and how they track their finances. Everything those devices are capable of, in terms of speed, reliability, and developer quality, flows from the engineering platform this role leads.

We are building a dedicated POS Application Platform function: the foundational engineering layer that sits beneath every POS product at Moniepoint. Think of it as the operating system for our POS engineering organisation - the standards, frameworks, tooling, and architectur
```
### Head of Engineering, POS Application Platform  [score 0.5447, live=True]
apply: https://job-boards.eu.greenhouse.io/moniepoint/jobs/4885572101
posted: 2026-06-10T06:52:04-04:00 | company_does: africa's all-in-one financial platform powering payments, banking, credit, cross-border, and business tools | industry: fintech | stage: growth_startup
signals: strong_title=True gap=False jd_lexicon=True
JD excerpt (snapshot):
```
**Who we are** 
...
We are building a dedicated POS Application Platform function: the foundational engineering layer that sits beneath every POS product at Moniepoint. Think of it as the operating system for our POS engineering organisation — the standards, frameworks, tooling, and architectu
```
### Engineering Manager  [score 0.4642, live=True]
apply: https://job-boards.eu.greenhouse.io/moniepoint/jobs/4792180101
posted: 2026-06-02T08:59:25-04:00 | company_does: africa's all-in-one financial platform powering payments, banking, credit, cross-border, and business tools | industry: fintech | stage: growth_startup
...
- Osun, Nigeria
- Business Relationship Manager (Osun)
- Rivers, Nigeria
...
- Remote
- Data Analyst - Fraud
- Data Entry Officer (Abia)
- Anambra, Nigeria
- Data Entry Officer (Anambra)
- Enugu, Nigeria
- Data Entry Officer (Enugu)
- Imo, Nigeria
- Data Entry Officer (Imo)
- Data Entry Officer (Lagos)
- Ogun, Nigeria
- Data Entry Officer (Ogun)
- Oyo, Nigeria
- Data Entry Officer (Oyo)
- Remote, Spain
